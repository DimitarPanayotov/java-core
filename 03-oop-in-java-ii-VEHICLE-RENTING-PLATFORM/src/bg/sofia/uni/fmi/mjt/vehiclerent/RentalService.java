...
import bg.sofia.uni.fmi.mjt.vehiclerent.vehicle.Caravan;
...
public class RentalService {
    ...
    public void rentVehicle(Driver driver, Vehicle vehicle, LocalDateTime startOfRent) {
        if (driver == null || vehicle == null || startOfRent == null) {
            throw new IllegalArgumentException("Cannot pass null arguments in rentVehicle method!");
        }
    ...
    public double returnVehicle(Vehicle vehicle, LocalDateTime endOfRent) throws InvalidRentingPeriodException {
        if (vehicle == null || endOfRent == null) {
            throw new IllegalArgumentException("Vehicle or endOfRent cannot be null in @returnVehicle!");
        }

        double price = vehicle.calculateRentalPrice(vehicle.getLastStartRentTime(), endOfRent) + vehicle.getCurrentDriver().group().getTax();
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Price 1: " + priceToPay);
            ...
            priceToPay = rentalService.returnVehicle(dieselCar, rentStart.plusDays(5)); // 435.0
            System.out.println("Price 2: " + priceToPay);
        } catch (InvalidRentingPeriodException e) {
            System.out.println("Invalid rental period: " + e.getMessage());
        }
    }
